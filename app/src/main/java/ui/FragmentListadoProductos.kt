...
class FragmentListadoProductos : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var list  = mutableListOf<ModeloProductosResponse>()
        list.add(ModeloProductosResponse("0","APEX","descripcion",0,0,0,true,"https://logodownload.org/wp-content/uploads/2019/02/apex-legends-logo-3.png"))
        list.add(ModeloProductosResponse("0","chocolate","descripcion",0,0,0,true,"https://www.pngmart.com/files/17/Thing-PNG-Free-Download.png"))
        list.add(ModeloProductosResponse("0","nombre","descripcion",0,0,0,true,"https://www.pngmart.com/files/17/Thing-PNG-Free-Download.png"))
        list.add(ModeloProductosResponse("0","chocolate","descripcion",0,0,0,true,"https://www.pngmart.com/files/17/Thing-PNG-Free-Download.png"))
        list.add(ModeloProductosResponse("0","nombre","descripcion",0,0,0,true,"https://www.pngmart.com/files/17/Thing-PNG-Free-Download.png"))
        list.add(ModeloProductosResponse("0","chocolate","descripcion",0,0,0,true,"https://www.pngmart.com/files/17/Thing-PNG-Free-Download.png"))
        list.add(ModeloProductosResponse("0","nombre","descripcion",0,0,0,true,"https://www.pngmart.com/files/17/Thing-PNG-Free-Download.png"))
